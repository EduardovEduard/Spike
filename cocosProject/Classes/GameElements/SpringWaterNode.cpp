...
void SpringWaterNode::touch(float x) {
...
void SpringWaterNode::initBorder() {
...
void SpringWaterNode::update(float dt) {
    _drawNode->clear();
...
void SpringWaterNode::updateSprings() {
...
void SpringWaterNode::drawWater() {
